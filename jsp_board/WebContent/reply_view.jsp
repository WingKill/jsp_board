	...
	<form action="reply.do" method="post">
		...
		<table border="1" style="width: 500; background-color: gray;">
			...
			<tr>
				...
				<td style="background-color: white"><textarea name="bcontent" rows="10">${reply_view.bcontent}</textarea></td>
			</tr>
			<tr>
				<td style="background-color: pink" colspan="2"><input type="submit" value="답변">&nbsp;&nbsp;<a href="list.do">목록보기</a></td>
			</tr>
		</table>
	</form>
</body>
